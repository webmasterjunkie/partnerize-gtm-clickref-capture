...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Capture Partnerize Click Reference",
  "brand": {
  ...
  "description": "This template will look for, capture, and save the Partnerize Click Reference from your landing pages. You must ensure that this tag is deployed on all possible landing pages.",
  "containerContexts": [
    "WEB"
  ]
}
...
if (clickref != '') {
  localStorage.setItem(localStorageID, clickref);
  setCookie(localStorageID, clickref, cookieOptions);
}
